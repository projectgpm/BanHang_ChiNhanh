...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script>
        function LoadTonKho() {
            cbpTonKho.PerformCallback('DataSourceTK')
        }
    </script>
                    ...
                    <dx:LayoutItem Caption="Loại tồn kho" HorizontalAlign="Left" Width="100%">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer2" runat="server">
                                <dx:ASPxComboBox ID="ccbLoaiTonKho" runat="server" AutoPostBack="false" ClientInstanceName="ccbLoaiTonKho" SelectedIndex="0" OnSelectedIndexChanged="ccbLoaiTonKho_SelectedIndexChanged">
                                    <Items>
                    ...
                    <dx:LayoutItem Caption="Nhóm khách hàng" ColSpan="2" ShowCaption="False">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer3" runat="server">
                                ...
                                <dx:ASPxGridView ID="gridTonKho" runat="server" AutoGenerateColumns="False" ClientInstanceName="gridTonKho" DataSourceID="dsTonKho" KeyFieldName="IDHangHoa" OnCustomColumnDisplayText="gridTonKho_CustomColumnDisplayText" Width="100%" OnRowValidating="gridTonKho_RowValidating">
                                    <SettingsDetail ShowDetailRow="True" />
                                    <Templates>
                                        <DetailRow>
                                            <div style="width: 100%; text-align:center;">
                    <div style="display:inline-block;">
                        <dx:ASPxGridView ID="gridTheKho" runat="server" AutoGenerateColumns="False" DataSourceID="dsTheKho" KeyFieldName="ID" Width="800px" OnBeforePerformDataSelect="gridTheKho_BeforePerformDataSelect">
